...
constexpr uint8_t NCI_MODE_SET_NTF_REASON_CODE_INDEX = 4;
constexpr uint8_t NCI_EE_STATUS_NTF_REASON_CODE_INDEX = 4;
constexpr uint8_t NCI_EE_STATUS_NTF_EE_INDEX = 3;
constexpr uint8_t MAX_ESE_RECOVERY_COUNT = 5;
