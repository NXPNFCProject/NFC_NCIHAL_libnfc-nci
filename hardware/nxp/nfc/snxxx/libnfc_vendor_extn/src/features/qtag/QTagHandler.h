...
constexpr uint8_t QTAG_DISABLE_OID = 0x00;
constexpr uint8_t QTAG_ENABLE_OID = 0x01;
constexpr uint8_t QTAG_APPEND_OID = 0x02;
constexpr uint8_t QTAG_DETECTION_OID = 0x03;

constexpr uint8_t QTAG_NCI_VENDOR_RSP_SUCCESS[] = {
    NCI_PROP_RSP_VAL, NCI_ROW_PROP_OID_VAL, PAYLOAD_TWO_LEN,
    (QTAG_FEATURE_SUB_GID | QTAG_ENABLE_OID), QTAG_STATUS_SUCCESS};
constexpr uint8_t QTAG_NCI_VENDOR_RSP_FAILURE[] = {
    NCI_PROP_RSP_VAL, NCI_ROW_PROP_OID_VAL, PAYLOAD_TWO_LEN,
    (QTAG_FEATURE_SUB_GID | QTAG_ENABLE_OID), QTAG_STATUS_FAILED};
...
constexpr uint8_t QTAG_DETECTION_NTF_SUCCESS[] = {
    NCI_PROP_NTF_VAL, NCI_ROW_PROP_OID_VAL, PAYLOAD_TWO_LEN,
    (QTAG_FEATURE_SUB_GID | QTAG_DETECTION_OID), QTAG_STATUS_SUCCESS};
constexpr uint8_t QTAG_DETECTION_NTF_FAILURE[] = {
    NCI_PROP_NTF_VAL, NCI_ROW_PROP_OID_VAL, PAYLOAD_TWO_LEN,
    (QTAG_FEATURE_SUB_GID | QTAG_DETECTION_OID), QTAG_STATUS_FAILED};
